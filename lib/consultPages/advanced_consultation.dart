...
class AdvancedConsultation extends StatefulWidget {
  @override
  _AdvancedConsultationState createState() => _AdvancedConsultationState();
}

class _AdvancedConsultationState extends State<AdvancedConsultation> {
